...
export default function QuickAccessGrid() {
  ...
  const validSavedShortcuts = Array.isArray(savedShortcuts) ? savedShortcuts : [];
  const shortcuts = validSavedShortcuts.length > 0 ? validSavedShortcuts : DEFAULT_SHORTCUTS;
