...
export function LetterHeaderBlocks({ detail }: { detail: LetterDocumentDetail }) {
  ...
  return (
    <>
      ...
      ) : letterhead && letterhead.useFullImage && letterhead.fullImageUrl ? (
        // Kop utuh dari gambar: tampilkan gambar saja, tanpa teks/garis/warna aksen.
        <div className="mb-4">
          <img
            src={letterhead.fullImageUrl}
            alt="Kop Surat"
