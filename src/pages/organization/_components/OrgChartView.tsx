          ...
          {pageConfig.paper === "custom" ? (
            <div className="flex items-center gap-1.5">
              ...
              <input
                ...
                value={Number.isNaN(pageConfig.customWmm) ? "" : (pageConfig.customWmm ?? DEFAULT_CUSTOM_W_MM)}
                onChange={(e) => {
                  const num = e.target.value === "" ? NaN : Number(e.target.value);
                  setPageConfig((c) => ({ ...c, customWmm: Number.isNaN(num) ? DEFAULT_CUSTOM_W_MM : num }));
                }}
                onBlur={(e) => {
                  const parsed = Number(e.target.value);
                  const clamped = Math.min(
                    CUSTOM_PAPER_MAX_MM,
                    Math.max(CUSTOM_PAPER_MIN_MM, Number.isNaN(parsed) ? DEFAULT_CUSTOM_W_MM : parsed),
                  );
              ...
              <input
                ...
                min={CUSTOM_PAPER_MIN_MM}
                max={CUSTOM_PAPER_MAX_MM}
                value={Number.isNaN(pageConfig.customHmm) ? "" : (pageConfig.customHmm ?? DEFAULT_CUSTOM_H_MM)}
                onChange={(e) => {
                  const num = e.target.value === "" ? NaN : Number(e.target.value);
                  setPageConfig((c) => ({ ...c, customHmm: Number.isNaN(num) ? DEFAULT_CUSTOM_H_MM : num }));
                }}
                onBlur={(e) => {
                  const parsed = Number(e.target.value);
                  const clamped = Math.min(
                    CUSTOM_PAPER_MAX_MM,
                    Math.max(CUSTOM_PAPER_MIN_MM, Number.isNaN(parsed) ? DEFAULT_CUSTOM_H_MM : parsed),
                  );
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-1.5">
              <input
                ...
                max={30}
                step={1}
                value={Number.isNaN(pageConfig.marginMm) ? 0 : (pageConfig.marginMm ?? 0)}
                onChange={(e) => {
                  const num = Number(e.target.value);
                  setPageConfig((c) => ({ ...c, marginMm: Number.isNaN(num) ? 0 : num }));
                }}
