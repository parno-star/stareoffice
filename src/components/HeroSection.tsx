        ...
        <div className="grid gap-7 lg:grid-cols-[1fr_0.85fr] lg:items-center lg:gap-10">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <Button
                size="default"
                className="cursor-pointer gap-2 text-sm shadow-xl shadow-primary/25 font-semibold"
              ...
              <SignInButton>
                <Button variant="outline" size="default" className="cursor-pointer gap-2 text-sm">
                  Pilih Akun Demo / SSO
                </Button>
              </SignInButton>
            </div>
