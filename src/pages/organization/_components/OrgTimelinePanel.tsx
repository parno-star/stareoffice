...
export default function OrgTimelinePanel() {
  ...
  const filterOptions: Array<{
    ...
    ? [
        { value: "all", label: "Semua", count: data.counts.total ?? 0 },
        { value: "manager", label: "Atasan", count: data.counts.manager ?? 0 },
        {
          value: "department",
          label: "Departemen",
          count: data.counts.department ?? 0,
        },
        { value: "team", label: "Tim", count: data.counts.team ?? 0 },
        { value: "position", label: "Posisi", count: data.counts.position ?? 0 },
        {
          value: "dotted",
          label: "Jalur Sekunder",
          count: data.counts.dottedLine ?? 0,
        },
      ]
    : [];
        ...
        <CardContent className="space-y-3">
          {!data ? (
            ...
            <>
              ...
              {Array.isArray(data.topActors) && data.topActors.length > 0 ? (
