...
import EmployeePicker, { EmployeeMultiPicker } from "@/components/ui/EmployeePicker.tsx";
import type { PickedEmployee } from "@/components/ui/EmployeePicker.tsx";
import LetterheadManagerDialog from "./LetterheadManagerDialog.tsx";
import { useAuth } from "@/hooks/use-auth.ts";
import { useDebounce } from "@/hooks/use-debounce.ts";
import { cn } from "@/lib/utils.ts";

import { DEFAULT_PREFIXES } from "@/lib/constants.ts";
import { substituteLetterVariables, formatVariableDate } from "@/lib/letterVariables.ts";
import { memoLineFromSettings } from "@/lib/memoLine.ts";
            ...
            <div className="space-y-1.5">
              ...
              {numberMode === "auto" ? (
                <p className="text-[11px] text-muted-foreground">
                  ...
                  {typeof nextNumberPreview === "string" ? (
                    <>
                      {" "}(contoh berikutnya:{" "}
            ...
            <div className="space-y-1.5">
              ...
              {agendaMode === "auto" ? (
                <p className="text-[11px] text-muted-foreground">
                  ...
                  {typeof nextAgendaPreview === "string" ? (
                    <>
                      {" "}(berikutnya:{" "}
