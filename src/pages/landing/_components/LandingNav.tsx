...
export default function LandingNav() {
  ...
  // Tampilkan menu nav jika seksi terkait aktif (default true jika belum dimuat atau belum diatur)
  const navLinks = ALL_NAV_LINKS.filter((link) => {
    if (!visibility || typeof visibility !== "object" || Array.isArray(visibility)) return true;
    return (visibility as Record<string, boolean>)[link.sectionId] !== false;
  });
