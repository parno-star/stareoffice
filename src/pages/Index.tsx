...
export default function Index() {
  ...
  const isSectionVisible = (id: string): boolean => {
    ...
    return (visibility as Record<string, boolean>)[id] !== false;
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        {isSectionVisible("trustedBy") && <TrustedBySection />}
        {isSectionVisible("features") && <FeaturesSection />}
        {isSectionVisible("demo") && <ProductDemoSection />}
        {isSectionVisible("benefits") && <BenefitsSection />}
        {isSectionVisible("modules") && <ModulesSection />}
        {isSectionVisible("workflow") && <WorkflowSection />}
        {isSectionVisible("calls") && <CallsSection />}
        {isSectionVisible("security") && <SecuritySection />}
        {isSectionVisible("testimonial") && <TestimonialSection />}
        {isSectionVisible("pricing") && <PricingSection />}
        {isSectionVisible("cta") && <CTASection />}
        {isSectionVisible("footer") && <LandingFooter />}
      </div>
    </>
  );
}
