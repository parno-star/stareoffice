...
export const listEmployees = query({
  ...
  handler: async (ctx, args): Promise<Array<Doc<"users">>> => {
    ...
    // an active grant has organizationId === null and can view all.
    results = results.filter((u) => organizationId !== null && u.organizationId === organizationId);
...
export const listDepartments = query({
  ...
  handler: async (ctx): Promise<Array<string>> => {
    ...
    // admin without an active grant has organizationId === null → can view all departments.
