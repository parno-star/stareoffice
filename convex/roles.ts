...
export const MENU_ITEMS: ReadonlyArray<MenuDef> = [
  ...
  { key: "finance_laporan",   label: "Laporan Kinerja Keuangan", description: "Input & kelola laporan keuangan periodik ke Dashboard Direksi", path: "/laporan-keuangan" },
  ...
  { key: "bod_dashboard",  label: "Dashboard Direksi (BoD)",  description: "Ringkasan strategis eksekutif: KPI inti, kesehatan OKR, & keuangan", path: "/bod-dashboard" },
  { key: "strategic_issues", label: "Isu Strategis",          description: "Papan isu strategis & prioritas mendesak untuk perhatian Direksi", path: "/strategic-issues" },
...
export const SIDEBAR_GROUPS: ReadonlyArray<SidebarGroupDef> = [
  {
    ...
    section: "umum_dasar",
    menus: [
      "dashboard", "bod_dashboard", "strategic_issues", "chatbot", "notifications", "calendar", "letters",
      "document_archive",
    ],
  },
  {
  ...
  },
  {
    ...
    section: "spesifik_fungsional",
    menus: ["finance_dashboard", "finance_laporan", "finance_audit", "finance_settings"],
  },
  {
    id: "administrasi",
    label: "Administrasi",
...
const ADMIN_MENUS: ReadonlyArray<MenuKey> = withBase([
  "fund_requests","finance_dashboard","finance_laporan","finance_audit","finance_settings","travel","onboarding",
  "mentorship","teams","assets","jobs",
  "performance","grading","talent","reports","analytics","bod_dashboard","strategic_issues",
...
const HR_MANAGER_MENUS: ReadonlyArray<MenuKey> = withBase([
  ...
  "jobs","performance","grading","talent","reports","analytics","bod_dashboard","strategic_issues",
  "payroll","recruitment","okr","engagement","feedback360","pulse","offboarding",
...
const FINANCE_MANAGER_MENUS: ReadonlyArray<MenuKey> = withBase([
  "fund_requests","finance_dashboard","finance_laporan","finance_audit","finance_settings","travel",
]);

// 9. Finance Staff – input & basic reporting
const FINANCE_STAFF_MENUS: ReadonlyArray<MenuKey> = withBase([
  "fund_requests","finance_dashboard","finance_laporan","finance_audit","travel",
]);
...
const DIRECTOR_MENUS: ReadonlyArray<MenuKey> = withBase([
  "bod_dashboard","strategic_issues","teams","reports","analytics","performance","grading","talent","okr",
...
const DEPARTMENT_HEAD_MENUS: ReadonlyArray<MenuKey> = withBase([
  ...
  "reports","analytics","bod_dashboard","strategic_issues","payroll","recruitment","okr","engagement","feedback360",
...
/**
 * Roles allowed to create/edit/delete strategic issues on the BoD board.
 * Directors are read-only (they monitor), so they are intentionally excluded.
 */
export function canManageStrategicIssues(
