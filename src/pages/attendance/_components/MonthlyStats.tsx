  ...
  const items = [
    {
      icon: CalendarCheck,
      label: "Hari Hadir",
      value: (safeStats.presentDays ?? 0).toString(),
    ...
    },
    {
      icon: AlertTriangle,
      label: "Terlambat",
      value: (safeStats.lateDays ?? 0).toString(),
    ...
    },
    {
      icon: Clock,
      label: "Total Jam",
      value: formatMinutes(safeStats.totalMinutes ?? 0),
    ...
    },
    {
      icon: TrendingUp,
      label: "Rata-rata",
      value: formatMinutes(safeStats.avgMinutes ?? 0),
